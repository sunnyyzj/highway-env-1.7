...
from highway_env.envs.common.action import Action, ActionType, action_factory,DiscreteDualObjectMetaAction
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "action": {"type": "DiscreteDualObjectMetaAction"}, ## "type": "DiscreteMetaAction"
